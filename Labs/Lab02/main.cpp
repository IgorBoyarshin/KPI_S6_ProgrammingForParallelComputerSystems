...
unsigned int min(const Vector& vector, unsigned int low, unsigned int high);
unsigned int max(const Vector& vector, unsigned int low, unsigned int high);
...
// HANDLE Semaphore_Calculations2EndIn2;
// HANDLE Semaphore_Calculations2EndIn3;
// HANDLE Semaphore_Calculations2EndIn4;
...
void T1() {
    ...
    // 5.
    unsigned int a1 = min(Z, low, high);
    ...
    // 7.
    unsigned int b1 = max(Z, low, high);
...
void T2() {
    ...
    // 5.
    unsigned int a2 = min(Z, low, high);
    ...
    // 7.
    unsigned int b2 = max(Z, low, high);
...
void T3() {
    ...
    // 5.
    unsigned int a3 = min(Z, low, high);
    ...
    // 7.
    unsigned int b3 = max(Z, low, high);
...
void T4() {
    ...
    // 5.
    unsigned int a4 = min(Z, low, high);
    ...
    // 7.
    unsigned int b4 = max(Z, low, high);
